...
<div class="py-5 bg-white">
    <div class="px-4 my-5 text-center">
        <h1 class="display-5 fw-bold mt-4">Kimly Contact App</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                ...
                <p>In the event of contact deletion or corruption, keep your contacts secure and unharmed across all
                    of your connected accounts.</p>
            </div>
            <div class="col-lg-4">
                <h3>Notes & Tags</h3>
